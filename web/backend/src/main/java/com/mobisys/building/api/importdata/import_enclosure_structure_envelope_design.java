...
@RestController
@RequestMapping(value = "/import_enclosure_structure_envelope_design")
public class import_enclosure_structure_envelope_design {
    @Autowired
    private EnclosureStructureEnvelopeDesignService enclosureStructureEnvelopeDesignService;
    private double flag = 0;
    int count=0;
    @ResponseBody
    @RequestMapping("/upload_enclosure_structure_envelope_design")
        ...
        try {
            if(name!=null){
                ...
                for (int i = 1; i <= RowNum; i++){
                    ...
                    EnclosureStructureEnvelopeDesignInfo enclosureStructureEnvelopeDesignInfo=new EnclosureStructureEnvelopeDesignInfo();
                    ...
                    if (row != null) {
                        ...
                        if (cells[0]!=null){
                            ...
                            enclosureStructureEnvelopeDesignInfo.setStationId((int) cells[0].getNumericCellValue());
                        }else{
                        ...
                        if (cells[1]!=null){
                            ...
                            enclosureStructureEnvelopeDesignInfo.setStructureName(cells[1].getStringCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setStructureName(null);
                        }

                        if (cells[2]!=null){
                            cells[2].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam1(cells[2].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam1(null);
                        }

                        if (cells[3]!=null){
                            cells[3].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam2(cells[3].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam2(null);
                        }
                        if (cells[4]!=null){
                            cells[4].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam3(cells[4].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam3(null);
                        }

                        if (cells[5]!=null){
                            cells[5].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam4(cells[5].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam4(null);
                        }
                        if (cells[6]!=null){
                            cells[6].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam5(cells[6].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam5(null);
                        }

                        if (cells[7]!=null){
                            cells[7].setCellType(CellType.NUMERIC);//设置单元格格式
                            enclosureStructureEnvelopeDesignInfo.setParam6(cells[7].getNumericCellValue());
                        }else{
                            enclosureStructureEnvelopeDesignInfo.setParam6(null);
                        }
                    ...
                    if (enclosureStructureEnvelopeDesignInfo!= null) {
                        enclosureStructureEnvelopeDesignService.update_enclosure_structure_envelope_design(enclosureStructureEnvelopeDesignInfo);
