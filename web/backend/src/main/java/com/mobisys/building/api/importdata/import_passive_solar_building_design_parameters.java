...
@RestController
@RequestMapping(value = "/import_passive_solar_building_design_parameters")
public class import_passive_solar_building_design_parameters {
    @Autowired
    ...
    int count=0;
    @ResponseBody
    @RequestMapping("/upload_passive_solar_building_design_parameters")
        ...
        try {
            if(name!=null){
                ...
                for (int i = 1; i <= RowNum; i++){
                    ...
                    PassiveSolarBuildingDesignParametersInfo passiveSolarBuildingDesignParametersInfo =new PassiveSolarBuildingDesignParametersInfo();
                    ...
                    if (row != null) {
                        ...
                        if (cells[0]!=null){
                            ...
                            passiveSolarBuildingDesignParametersInfo.setStationId((int) cells[0].getNumericCellValue());
                        }else{
                        ...
                        if (cells[1]!=null){
                            ...
                            passiveSolarBuildingDesignParametersInfo.setType(cells[1].getStringCellValue());
                        }else{
                            buffer.add("数据集缺少重要信息！！");
                            jsonObject.put("message",buffer.toString());
                            return jsonObject;
                        ...
                        if (cells[2]!=null){
                            ...
                            passiveSolarBuildingDesignParametersInfo.setWinterHeatingCalculationTemperature(cells[2].getStringCellValue());
                        }else{
                            passiveSolarBuildingDesignParametersInfo.setWinterHeatingCalculationTemperature(cells[2].getStringCellValue());
                        }
                        ...
                        if (cells[3]!=null){
                            ...
                            passiveSolarBuildingDesignParametersInfo.setSummerCoolingCalculationTemperature(cells[3].getStringCellValue());
                        }else{
                            passiveSolarBuildingDesignParametersInfo.setSummerCoolingCalculationTemperature(cells[3].getStringCellValue());
                        }
                        if (cells[4]!=null){
                            cells[4].setCellType(CellType.STRING);//设置单元格格式
                            passiveSolarBuildingDesignParametersInfo.setSummerHotAndHumidAreas(cells[4].getStringCellValue());
                        }else{
                            passiveSolarBuildingDesignParametersInfo.setSummerHotAndHumidAreas(cells[4].getStringCellValue());
                        }
                    ...
                    if (passiveSolarBuildingDesignParametersInfo!= null) {
                        passiveSolarBuildingDesignParametersService.update_passive_solar_building_design_parameters(passiveSolarBuildingDesignParametersInfo);
