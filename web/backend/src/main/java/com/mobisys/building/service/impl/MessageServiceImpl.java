...
public class MessageServiceImpl implements MessageService {
    ...
    static final String accessKeyId = "LTAI4Fn37DjiuwwqkGKw25Su";
    static final String accessKeySecret = "fsCy12qIi319VP5fcvTgzXa3hDjuOs";
    //短信签名名称——请在控制台签名管理页面签名名称一列查看。
    static final String SignName = "建筑节能";
    //短信模板ID——请在控制台模板管理页面模板CODE一列查看。
    static final String TemplateCode = "SMS_177243057";
//    //上行短信扩展码，无特殊需要此字段的用户请忽略此字段。
//    static final String SmsUpExtendCode = "5555";
//    //外部流水扩展字段。
//    static final String OutId = "waibuliushuikuozhan";
