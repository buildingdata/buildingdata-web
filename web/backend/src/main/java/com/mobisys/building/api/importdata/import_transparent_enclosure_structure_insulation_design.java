...
@RestController
@RequestMapping(value = "/import_transparent_enclosure_structure_insulation_design")

public class import_transparent_enclosure_structure_insulation_design {
    @Autowired
    ...
    int count=0;
    @ResponseBody
    @RequestMapping("/upload_transparent_enclosure_structure_insulation_design")
        ...
        try {
            if(name!=null){
                ...
                for (int i = 1; i <= RowNum; i++){
                    ...
                    TransparentEnclosureStructureInsulationDesignInfo transparentEnclosureStructureInsulationDesignInfo=new TransparentEnclosureStructureInsulationDesignInfo();
                    ...
                    if (row != null) {
                        ...
                        if (cells[0]!=null){
                            ...
                            transparentEnclosureStructureInsulationDesignInfo.setStationId((int) cells[0].getNumericCellValue());
                        }else{
                        ...
                        if (cells[1]!=null){
                            ...
                            transparentEnclosureStructureInsulationDesignInfo.setClimateZones(cells[1].getStringCellValue());
                        }else{
                            buffer.add("数据集缺少重要信息！！");
                            jsonObject.put("message",buffer.toString());
                            return jsonObject;
                        ...
                        if (cells[2]!=null){
                            ...
                            transparentEnclosureStructureInsulationDesignInfo.setKValue(cells[2].getStringCellValue());
                        }else{
                            transparentEnclosureStructureInsulationDesignInfo.setKValue(cells[2].getStringCellValue());
                        }
                        ...
                        if (cells[3]!=null){
                            ...
                            transparentEnclosureStructureInsulationDesignInfo.setResistanceToCondensation(cells[3].getStringCellValue());
                        }else{
                            transparentEnclosureStructureInsulationDesignInfo.setResistanceToCondensation(cells[3].getStringCellValue());
                        }
                        if (cells[4]!=null){
                            cells[4].setCellType(CellType.STRING);//设置单元格格式
                            transparentEnclosureStructureInsulationDesignInfo.setBasicThermalComfort(cells[4].getStringCellValue());
                        }else{
                            transparentEnclosureStructureInsulationDesignInfo.setBasicThermalComfort(cells[4].getStringCellValue());
                        }
                    ...
                    if (transparentEnclosureStructureInsulationDesignInfo!= null) {
                        transparentEnclosureStructureInsulationDesignService.update_transparent_enclosure_structure_insulation_design(transparentEnclosureStructureInsulationDesignInfo);
